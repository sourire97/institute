...
public class VisitController {
	...
	/*
	@Autowired : 자동엮기(연결)
	주의) @Autowired속성을 갖는 컴포넌트생성시 수동생성일 경우에는 <context:annotation-config/>을 반드시 생성전에 설정해야 한다
	DispacherServlet에게 자동연결 요청 : 메소드 호출시 마다 자동 Injection 시켜준다
	*/
	@Autowired
	...
	public String modify_form(int idx, Model model) {
		...
		return "visit/visit_modify_form";// DS ViewName전달 -> ViewResolver 뷰경로및 확장자 붙인다 -> forward시킨다
	}
	...
	public String delete(int idx,HttpServletResponse response) {
